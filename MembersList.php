    ...
    <div class="page-header" style="margin-bottom:0px;">
      <div class="row">
        <div class="col">
          ...
          <a class="btn btn-sm bg-success mr-2 float-right text-white font-weight-bold" href="addedit_customer.php"> <i class="fe fe-plus"></i> Add </a> 
          </h3>
          <ul class="breadcrumb">
              ...
              <table class="table table-hover table-center mb-0" id="employee-grid">
                <thead>
                  ...
                  <th>Sr No</th>
                    ...
                    <th>Senior</th>
                    <th>Address</th>                   
                    <th>Created at / Register Date</th>
...
"ajax":{
url :"return_func.php?state="+state+"&status="+status+"&part=All_Members_List", 
