    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-success " name="AddCity">Add City</button>
        </form>
      </div>
    </div>
  </div>
...
"ajax":{
url :"return_func.php?state="+state+"&status="+status+"&part=All_City_Data", 
